...
@Entity
@Table(name = "nv_quyetdinhthangchuc")
public class NvQuyetdinhthangchuc implements Serializable {
	...
	public NvQuyetdinhthangchuc() {
	}

	public NvQuyetdinhthangchuc(Integer id) {
		this.id = id;
	}

	public NvQuyetdinhthangchuc(Integer id, String tenquyetdinh, Date ngayquyetdinh, Date ngayhieuluc, String noidung,
			int status) {
		this.id = id;
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof NvQuyetdinhthangchuc)) {
			return false;
		}
		NvQuyetdinhthangchuc other = (NvQuyetdinhthangchuc) object;
	...
	public String toString() {
		return "com.dangmailinh.entities.NvQuyetdinhthangchuc[ id=" + id + " ]";
	}
