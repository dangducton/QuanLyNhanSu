...
@Entity
@Table(name = "nv_quyetdinhnanghesochuyenmon")
public class NvQuyetdinhnanghesochuyenmon implements Serializable {
	...
	public NvQuyetdinhnanghesochuyenmon() {
	}

	public NvQuyetdinhnanghesochuyenmon(Integer id) {
		this.id = id;
	}

	public NvQuyetdinhnanghesochuyenmon(Integer id, String tenquyetdinh, Date ngayquyetdinh, Date ngayhieuluc,
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof NvQuyetdinhnanghesochuyenmon)) {
			return false;
		}
		NvQuyetdinhnanghesochuyenmon other = (NvQuyetdinhnanghesochuyenmon) object;
	...
	public String toString() {
		return "com.dangmailinh.entities.NvQuyetdinhnanghesochuyenmon[ id=" + id + " ]";
	}
