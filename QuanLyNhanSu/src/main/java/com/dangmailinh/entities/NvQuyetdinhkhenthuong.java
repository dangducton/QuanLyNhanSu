...
@Entity
@Table(name = "nv_quyetdinhkhenthuong")
public class NvQuyetdinhkhenthuong implements Serializable {
	...
	public NvQuyetdinhkhenthuong() {
	}

	public NvQuyetdinhkhenthuong(Integer id) {
		this.id = id;
	}

	public NvQuyetdinhkhenthuong(Integer id, String tenquyetdinh, Date ngayquyetdinh, Date ngayhieuluc, String noidung,
			double tienthuong, int status) {
		this.id = id;
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof NvQuyetdinhkhenthuong)) {
			return false;
		}
		NvQuyetdinhkhenthuong other = (NvQuyetdinhkhenthuong) object;
	...
	public String toString() {
		return "com.dangmailinh.entities.NvQuyetdinhkhenthuong[ id=" + id + " ]";
	}
